...
const LoginComponent = (props) => {
    ...
    return (
        <div>
            ...
            <ButtonWrap>            
            {
                    isEmail&&isPassword? <SuccessButton onClick={onClickLogin}>로그인</SuccessButton>: <FailButton >로그인</FailButton>
                }            
              <div style={{border:"1px solid", width:"50%",cursor:"pointer"}}onClick={()=>props.setLoginOrSignUp(false)}>회원가입</div>
            </ButtonWrap>
